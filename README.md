<p><img src="docs/assets/app-icon.svg" width="88" height="88" alt="purecalendar icon"></p>

# purecalendar

**Plan events and see your schedule.** An app for [puredesktop](https://puredesktop.ai).
...
A calendar for viewing and editing events, managing calendars, and planning around tasks. Switch between day, week, month, and agenda views, and connect supported calendar accounts or use iCalendar files.
...
Connected calendar accounts and synchronization need the host’s supported account integration and network access.
...
| --- | --- |
| **Calendar navigation** | Select calendars and move to the date you want to work on. |
| **View controls** | Choose a day, week, month, or agenda view. |
| **Calendar area** | See events arranged by time or as an agenda and select one to inspect it. |
| **Event details** | Review or edit dates, times, attendees, location, and other event information. |
...
> Find my events for next week.
>
> Draft an event for tomorrow afternoon.

The app exposes 8 tools, including `listCalendarEvents`, `searchCalendar`, `getCalendarSettings`. See [agents.md](agents.md) for workflows and [plugin.json](plugin.json) for the complete tool schemas and approval flags. Some actions apply directly, while approval-marked actions ask first. Check the result in the app after a change.

## Files and data

Work with calendar events and iCalendar imports/exports. Provider-backed changes synchronize to the connected service; activating a draft can send invitations to its attendees.

## Develop and customize

We welcome **developers and vibecoders alike**. Fork purecalendar, add a feature, or use what you learn to build a new app.
...
Check time zones, calendar permissions, and attendees before activating an event. Remote deletions take effect on synchronization.
...
Manage calendars and events in [puredesktop](https://puredesktop.ai).
